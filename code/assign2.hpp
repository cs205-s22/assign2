...
#define ADD_NODE_LEFT(father, child) \
    __ans_add_node(father, child, CHILD_DIRECTION_LEFT)

#define ADD_NODE_RIGHT(father, child) \
    __ans_add_node(father, child, CHILD_DIRECTION_RIGHT)
 ...
 */
assign2_exception::exception __ans_add_node(tree_node *father, tree_node *child, int child_direction);
 ...
 */
assign2_exception::exception __ans_judge_child_direction(tree_node *node, int *child_direction);
 ...
 */
assign2_exception::exception __ans_insert_into_BST(BST *bst, uint64_t data, tree_node **inserted_node);
 ...
 * @exception assign2_exception::NULL_COMP_FUNCTION_EXCEPTION
 */
assign2_exception::exception __ans_find_in_BST(BST *bst, uint64_t data, tree_node **target_node);
